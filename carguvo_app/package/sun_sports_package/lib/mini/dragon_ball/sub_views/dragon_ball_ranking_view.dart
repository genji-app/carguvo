...
class DragonBallRankingView extends StatefulWidget {
  final VoidCallback onBack;
  final VoidCallback onClose;
  final BorderRadius borderRadius;

  const DragonBallRankingView({
  ...
  @override
  State<DragonBallRankingView> createState() => _DragonBallRankingViewState();
}

class _DragonBallRankingViewState extends State<DragonBallRankingView> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _LoaiRow(type: item.description),
                  const SizedBox(height: 4),
                  Text(
...
class _LoaiRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isJackpot = type.toLowerCase().contains('nổ hũ');
    return Row(
