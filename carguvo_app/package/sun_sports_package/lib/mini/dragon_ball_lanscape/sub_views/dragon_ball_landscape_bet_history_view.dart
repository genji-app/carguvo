...
const double _kLineColW = 90;
const double _kWinColW = 110;
const double _kChevronW = 28;

class DragonBallLandscapeBetHistoryView extends StatefulWidget {
  final VoidCallback onBack;
  final VoidCallback onClose;
  final ValueChanged<DragonBallHistoryItem> onItemTap;
  final BorderRadius borderRadius;

  const DragonBallLandscapeBetHistoryView({
  ...
  @override
  State<DragonBallLandscapeBetHistoryView> createState() =>
      _DragonBallLandscapeBetHistoryViewState();
}

class _DragonBallLandscapeBetHistoryViewState
    extends State<DragonBallLandscapeBetHistoryView> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(
            width: _kWinColW,
            child: Text('Tiền thắng', textAlign: TextAlign.right, style: style),
          ),
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                width: _kLineColW,
                child: Center(child: MinipokerGoldNumber('${item.wonLines}')),
              ),
              SizedBox(
                width: _kWinColW,
                child: Align(
