    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          CollapseAllToggle(provider: upcomingEventCollapseAllProvider),
        ],
      ),
    );
  }
    ...
    return asyncLeagues.when(
          ...
          builder: (scrollController) => ScrollConfiguration(
            ...
            child: CustomScrollView(
              ...
              LeagueEventsSliverV2(
                ...
                showBackToTop: false,
                collapseAllProvider: upcomingEventCollapseAllProvider,
      ...
      error: (err, _) => Center(
        child: Padding(
          ...
          child: Text(
            localizedOrGenericError('UpcomingEvents', err.toString()),
