...
class SlipTransactionView extends ConsumerWidget {
  const SlipTransactionView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final filter = TransactionFilter.slip;
    ...
    return RefreshIndicator.adaptive(
      ...
      child: LoadMoreListener(
        ...
        child: CustomScrollView(
          key: const PageStorageKey<String>('slip_transaction_scroll_key'),
          slivers: [
