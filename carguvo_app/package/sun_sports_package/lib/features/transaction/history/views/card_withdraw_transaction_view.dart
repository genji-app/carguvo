...
class CardWithdrawTransactionView extends ConsumerWidget {
  const CardWithdrawTransactionView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final filter = TransactionFilter.cardWithdraw;
      ...
      child: LoadMoreListener(
        ...
        child: CustomScrollView(
          key: const PageStorageKey<String>(
            'card_withdraw_transaction_scroll_key',
          ),
          slivers: [
              ...
              builder: (context, ref, _) {
                ...
                return switch (status) {
                  ...
                  PaginatedStatus.noData => _SliverNoTransactionData(
                    onWithdrawPressed: () => showWithdrawFlow(context, ref),
                  ),
...
class _SliverNoTransactionData extends StatelessWidget {
  const _SliverNoTransactionData({this.onWithdrawPressed});
